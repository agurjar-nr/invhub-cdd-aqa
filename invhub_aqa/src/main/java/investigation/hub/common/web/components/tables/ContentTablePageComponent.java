...
@Log4j2
@PageComponent
public class ContentTablePageComponent extends TableGeneralComponent<ContentTablePageComponent.HeaderName> {
    ...
    @Step("User sorts Content table by column")
    public ContentTablePageComponent sortTable(HeaderName headerName, SortStatus sortStatus) {
        ...
        log.info("Sort Сontent table by column: " + headerName.getStringValue());
        return this;
    }
